...
The other area they impress in is voyages. Their #2 debut score makes for only the second crew to join the game at that altitude in over two years. While the skill set is frankly overrepresented, RSK attempts to sidestep a low value over replacement with raw power. The score gap between them and CMD/DIP/SCI #2 is the same as that between #2 and #10 - they're in a league of their own.
