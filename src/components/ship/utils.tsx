...
export function formatShipScore(kind: string, score: number | undefined, t: TranslateMethod, divisor = 100, styles?: React.CSSProperties, separator?: string | React.ReactNode) {
    if (!score) return <></>;
