		...
		return (
			...
			<div
				...
				<div style={{ gridArea: 'icon' }}>
					<img src={`${process.env.REACT_ASSETS_URL}atlas/icon_${this.props.skill_name}.png`} style={{ height: `${2 * scale}em` }} />
				</div>
				{!!stats && (
					<React.Fragment>
						{!proficiencies &&
						...
						<div style={{ gridArea: 'crits', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
							<img src={`${process.env.REACT_ASSETS_URL}atlas/crit_icon_gauntlet.png`} style={{ height: `${1 * scale}em` }} />
