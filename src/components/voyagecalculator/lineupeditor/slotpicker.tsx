...
export const AlternateSlotPicker = (props: AlternateSlotPickerProps) => {
	...
	columns.push(
		{
			id: 'antimatter',
			title: <img src={`${process.env.VITE_ASSETS_URL}atlas/icon_antimatter.png`} style={{ height: '1em', verticalAlign: 'middle' }} className='invertibleIcon' />,
			align: 'center',
	...
	function renderSkillHeader(skill: string): React.ReactNode {
		return (
			<React.Fragment>
				<img src={`${process.env.VITE_ASSETS_URL}atlas/icon_${skill}.png`} style={{ height: '1.1em', verticalAlign: 'middle' }} />
						...
						<Table.Body>
							<Table.Row>
								...
								<Table.Cell textAlign='center'>
									<img src={`${process.env.VITE_ASSETS_URL}atlas/icon_antimatter.png`} style={{ height: '1.1em', verticalAlign: 'middle' }} className='invertibleIcon' />
								</Table.Cell>
								<Table.Cell /* Estimate */
									textAlign='center'
								>
