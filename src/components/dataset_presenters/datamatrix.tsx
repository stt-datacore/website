...
export const DataMatrix = (props: DataMatrixProps) => {
	...
	function renderMatrixCell(rowId: string, columnId: string): React.ReactNode {
	...
	function renderDefaultCell(datum: IEssentialMatrixData, isSelected: boolean): React.ReactNode {
		return (
			<React.Fragment>
