...
const UsefulPolestars = (props: UsefulPolestarsProps) => {
	...
	function renderUsefulPolestars(): React.ReactNode {
		return (
	...
	function renderPolestarsInline(polestars: IPolestar[]): React.ReactNode {
	...
	function renderUsableConstellations(): React.ReactNode {
