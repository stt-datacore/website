...
export const HintPickerModal = (props: HintPickerModalProps) => {
	...
	function renderActions(dataPickerState: IDataPickerState): React.ReactNode {
	...
	function renderDeduction(option: IDeductionOption, isSelected: boolean): React.ReactNode {
