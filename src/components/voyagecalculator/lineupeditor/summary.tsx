						...
						return (
							...
							>
								<Table.Cell textAlign='center'>
									<img src={`${process.env.REACT_APP_ASSETS_URL}atlas/icon_${cs.skill}.png`} style={{ height: '1.1em', verticalAlign: 'middle' }} />
								</Table.Cell>
								<Table.Cell>
									{renderCrew(cs)}
								</Table.Cell>
...
function renderAntimatter(value: number): React.ReactNode {
	return (
		<React.Fragment>
			{value} <img src={`${process.env.REACT_APP_ASSETS_URL}atlas/icon_antimatter.png`} style={{ height: '1.1em', verticalAlign: 'middle' }} className='invertibleIcon' />
		</React.Fragment>
	);
}
...
function renderVP(value: number): React.ReactNode {
	return (
		<React.Fragment>
			{value.toLocaleString()} <img src={`${process.env.REACT_APP_ASSETS_URL}atlas/victory_point_icon.png`} style={{ height: '1.1em', verticalAlign: 'middle' }} className='invertibleIcon' />
		</React.Fragment>
	);
}
