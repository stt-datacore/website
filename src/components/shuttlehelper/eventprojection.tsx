...
export const EventProjection = (props: EventProjectionProps) => {
	...
	function renderNeeds(): React.ReactNode {
...
const Scheduler = (props: SchedulerProps) => {
	...
	function renderSchedule(schedule: ISchedule, idx: number): React.ReactNode {
...
const ScheduleRow = (props: ScheduleRowProps) => {
	...
	function renderCount(): React.ReactNode {
	...
	function renderDuration(): React.ReactNode {
	...
	function renderRate(): React.ReactNode {
