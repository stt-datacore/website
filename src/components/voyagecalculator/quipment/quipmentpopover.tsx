            ...
            trigger={
                <div style={{...flexCol, margin: 0, padding: 0}}>
                    <div style={{ cursor: 'help', display: 'flex', alignItems: 'center', flexWrap: 'nowrap' }}>
                        <img src={`${import.meta.env.VITE_ASSETS_URL}atlas/ContinuumUnlock.png`} style={{ marginLeft: "0.25em", marginRight: "0.25em", height: '1em', verticalAlign: 'middle' }} className='invertibleIcon' />
