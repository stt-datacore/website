...
## [Client API 27 Game Data Link](https://app.startrektimelines.com/player?client_api=30&only_read_state=true)
`https://app.startrektimelines.com/player?client_api=30&only_read_state=true`
