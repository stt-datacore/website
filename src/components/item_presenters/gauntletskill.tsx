        ...
        if (Array.isArray(node)) {
            ...
            return (<div style={{gridArea: 'left', display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center'}}>
                ...
                <div style={{margin: "0.5em"}}>
                    ...
                    <img style={{width: '1em'}} src={`${import.meta.env.VITE_ASSETS_URL}atlas/icon_${node.contest_data?.featured_skill}.png`} />
                    : ''}
                </div>
            </div>)
        }
        ...
        return (<div style={{
            ...
            <div style={{
                ...
                <div style={{gridArea: 'right', fontSize: "12pt", marginTop: "1em", marginBottom: "1em"}} title={t('base.best_pair')}>
                    <img style={{height: '2em', margin: "0.25em"}} src={`${import.meta.env.VITE_ASSETS_URL}atlas/icon_${pairs[0][0].skill}.png`} />
                    <img style={{height: '2em', margin: "0.25em"}} src={`${import.meta.env.VITE_ASSETS_URL}atlas/icon_${pairs[0][1].skill}.png`} />
