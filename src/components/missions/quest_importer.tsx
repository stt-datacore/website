...
export const QuestImportComponent = (props: QuestImporterProps) => {
    ...
    const { currentHasRemote, questId, quest, setQuest, setError } = props;
			...
			<React.Fragment>
                {!currentHasRemote && <Notification
                    ...
                    content={
                        ...
                        <p>
                            Current Quest Data: <b><a target='_blank' href={`https://app.startrektimelines.com/quest/conflict_info?id=${quest?.id}&client_api=22&continuum=true`}>{quest?.name}</a></b>
                        </p>
                        </>
                    }
                    icon="database"                    
                ...
                {currentHasRemote && <Notification
                    ...
                    content={
                        ...
                        <p style={{textAlign: "right"}}>
							<b style={{fontSize:"0.8em"}}>(To clear your all quest data, <a title={'Clear All Quest Data'} onClick={() => setQuest(undefined)}>Click Here</a>)</b>
                        </p>
