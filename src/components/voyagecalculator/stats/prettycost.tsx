			...
			if (revivals && revivals.quantity && revivals.quantity >= idx) {
				...
				if (globalItem) {
					...
					return <div style={{
						...
						<img style={{height:"24px", margin:"0.5em"}} src={`${process.env.VITE_ASSETS_URL}${revivals.imageUrl}`} />
						</div>
				...
				return <div style={{
					...
					<div style={{width: "32px"}}>
					<img style={{height:"24px", margin:"0.5em"}} src={`${process.env.VITE_ASSETS_URL}atlas/pp_currency_icon.png`} />
					</div>
