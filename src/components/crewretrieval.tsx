...
// 							<img width={24} src={`${process.env.VITE_ASSETS_URL}${polestar.icon.file.slice(1).replace(/\//g, '_')}`} />
// 						</div>
...
// 							<img width={32} src={`${process.env.VITE_ASSETS_URL}${p.icon.file.slice(1).replace(/\//g, '_')}`} />
...
// 			if (c) options.list = [{ key: c.symbol, value: c.symbol, text: c.name, image: { avatar: true, src: `${process.env.VITE_ASSETS_URL}${c.imageUrlPortrait}` }}];
...
// 				return { key: c.symbol, value: c.symbol, text: c.name, image: { avatar: true, src: `${process.env.VITE_ASSETS_URL}${c.imageUrlPortrait}` }};
// 			}),
// 			initialized: true
// 		}
