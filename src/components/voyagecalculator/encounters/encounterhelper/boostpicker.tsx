...
function getTypeImg(type: string): string {
	if (type === 'voyage_crit_boost')
		return `${process.env.REACT_APP_ASSETS_URL}atlas/crit_icon_gauntlet.png`;
	return `${process.env.REACT_APP_ASSETS_URL}atlas/icon_${type}.png`;
}

function getConsumableImg(type: string, rarity: number): string {
	if (type === 'voyage_crit_boost')
		return `${process.env.REACT_APP_ASSETS_URL}items_consumables_voyage_crit_boost.png`;
	return `${process.env.REACT_APP_ASSETS_URL}items_consumables_${type.replace('_skill', '')}_consumable_${rarity}.png`;
}
