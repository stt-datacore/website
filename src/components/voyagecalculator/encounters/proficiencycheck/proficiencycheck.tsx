		...
		<ProficiencyContext.Provider value={proficiencyContext}>
			<React.Fragment>
				<div>
					...
					<img src={`${process.env.REACT_ASSETS_URL}atlas/crit_icon_gauntlet.png`} style={{ height: '1em', verticalAlign: 'middle' }} className='invertibleIcon' />{` `}{t('voyage.contests.notes.crit_icon')}
				</div>
